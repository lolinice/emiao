<template>
  <div class="main">
      ...
      <div class="header_inner">
        <div class="header_box">
          ...
          <div class="header_top">
            <div class="header_top_inner">
              ...
              <div class="header_search">
                <a href="javascript:;">
                  <input class="header_input" type="search" placeholder="搜索商品和品牌">
          ...
          <div class="header_bottom">
            <div class="header_nav swiper-container">
              <ul class="header_list swiper-wrapper">
                <li class="header_item swiper-slide on">
                  <a href="javascript:;">
                <span class="header_rela">
                  <span>首页</span>
                  <i class="iconfont icon-jianhao"></i>
                </span>
                  </a>
                </li>
                <li class="header_item swiper-slide">
                  <a href="javascript:;">
                <span class="header_rela">
                  <span>狗狗主粮</span>
                  <i></i>
    ...
    <div class="content">
      ...
      <div class="content_surprise">
        <div class="surprise_top">
          ...
          <div class="surprise_time">
            <div class="time_xqing">
              <span class="time_xqing1">16</span>
              <span class="time_xqing2">:</span>
              <span class="time_xqing1">00</span>
            </div>
          </div>
        ...
        <div class="surprise_bottom">
          <div class="surprise_inner">
            <div class="swiper-container">
      ...
      <!--kong-->
      <div class="content_kong">
        <div class="kong"></div>
      </div>
      <!--E宠国际-->
      <div class="content_echong">
            ...
            <li class="video_item">
              <a href="javascript:;">
                ...
                <div class="video_bottom">
                  <div class="bottom_gouzi">Industripet 缓食狗碗 狗子告别狼吞虎咽 </div>
          ...
          <ul class="video_list">
            <li class="video_item">
              <a href="javascript:;">
                ...
                <div class="video_bottom">
                  <div class="bottom_gouzi">第3期-汪星人你的大姨妈来了吗？ </div>
                  <div class="bottom_time">
                    <span class="iconfont icon-yanjing"></span>
                    <i>76326</i>
                    <span>|</span>
          ...
          <ul class="video_list">
            <li class="video_item">
              <a href="javascript:;">
                ...
                <div class="video_bottom">
                  <div class="bottom_gouzi">被宠物医院坑过的那些事儿 </div>
                  <div class="bottom_time">
                    <span class="iconfont icon-yanjing"></span>
                    <i>17543</i>
                    <span>|</span>
...
<script>
  ...
  export default {
    mounted(){
      /*头部导航*/
      var headerswiper = new Swiper('.header_bottom .swiper-container', {
        slidesPerView: 5,
        spaceBetween: 5,
        pagination: {
          el: '.header_bottom .swiper-pagination',
          clickable: true,
        },
      });

      /*轮播图*/
      var autoswiper = new Swiper('.content_banner .swiper-container', {
        spaceBetween: 30,
        centeredSlides: true,
        autoplay: {
          delay: 3500,
      ...
      /*新人*/
      var newswiper = new Swiper('.content_new .swiper-container',{
        noSwiping : true,
      });

      /*每日疯抢*/
      var surswiper = new Swiper('.surprise_bottom .swiper-container', {
        slidesPerView: 3.5,
        spaceBetween: 30,
      });

      /*团购商品预告*/
      var newswiper = new Swiper('.content_tgou .swiper-container',{
        noSwiping : true,
      });
    }
  }
        ...
        >.swiper-slide
          ...
          a
            ...
            img
              ...
              display block
              vertical-align middle
  .content_surprise //每日疯抢
    background-color #fff
    .surprise_top //每日疯抢上部分
      position relative
      padding 10px
      .surprise_every
        float left
